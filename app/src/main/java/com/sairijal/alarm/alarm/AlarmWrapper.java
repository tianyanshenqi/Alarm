...
public class AlarmWrapper implements Comparable<AlarmWrapper> {
    ...
    public static String[] getDays() {
        return com.sairijal.alarm.alarm.RemindTask.getDays();
    }

    public static int getSnoozeTime() {
        return com.sairijal.alarm.alarm.RemindTask.getSnoozeTime();
    }

    public static void setSnoozeTime(int snoozeTime) {
        com.sairijal.alarm.alarm.RemindTask.setSnoozeTime(snoozeTime);
    }
